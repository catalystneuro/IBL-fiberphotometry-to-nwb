...
class OpicalFibersAnatomicalLocalizationInterface(BaseIBLDataInterface):
    """An interface for IBL anatomical localization of optical fibers."""
    ...
    def add_to_nwbfile(
        ...
        *,
        ...
        """
        Add raw anatomical localization of optical fibers to the NWB file.
